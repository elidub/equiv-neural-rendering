...
def render_scene(scene_name, scene_folder, n_views, output_folder, color_depth, resolution, translation, rotation, local_path, remove_doubles = True, edge_split = True):
    ...
    fp_object_scene = local_path + scene_folder + "/models/model_normalized.obj"
    ...
    filepath = local_path + "/data_prep/demo/data/background.png"
    ...
    #######################################33
    output_folder = local_path + '/data_prep/demo/'+ output_folder
...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_path', type=str, default='path', # 128
                        help='Resolution of the images.')
    ...
    render_scene(args.scene_name, args.scene_folder, args.n_images, args.output_folder, args.color_depth, args.resolution, args.translation, args.rotation, args.local_path)
